...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Loading certificate fixtures..."))
        ...
        for fixtures_dir, fixture_file in fixture_files:
            ...
            try:
                ...
                self.stdout.write(self.style.ERROR(f"Error loading {fixture_file}: {str(e)}"))
                if verbosity >= 2:
                    import traceback

                    self.stdout.write(traceback.format_exc())

        self.stdout.write(self.style.SUCCESS("Certificate fixtures loading completed!"))
