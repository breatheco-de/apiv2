        ...
        expected = [
            {
                ...
                "specialty": {
                    ...
                    "syllabus_list": [s.slug for s in model["specialty"].syllabus_list.all()],
        ...
        expected = [
            {
                ...
                "specialty": {
                    ...
                    "syllabus_list": [s.slug for s in models[0].specialty.syllabus_list.all()],
            ...
            },
            {
                ...
                "specialty": {
                    ...
                    "syllabus_list": [s.slug for s in models[1].specialty.syllabus_list.all()],
