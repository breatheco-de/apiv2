        ...
        expected = [
            {
                ...
                "specialty": {
                    ...
                    "syllabus_many": [s.slug for s in model["specialty"].syllabus_many.all()],
        ...
        expected = [
            {
                ...
                "specialty": {
                    ...
                    "syllabus_many": [s.slug for s in models[0].specialty.syllabus_many.all()],
            ...
            },
            {
                ...
                "specialty": {
                    ...
                    "syllabus_many": [s.slug for s in models[1].specialty.syllabus_many.all()],
