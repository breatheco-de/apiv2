    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('RENEWAL', 'Renewal'), ('CHECKING', 'Checking'), ('PAID', 'Paid')],
                                  default='CHECKING',
                                  max_length=8)),
                ('type', models.CharField(choices=[('BAG', 'Bag'), ('PREVIEW', 'Preview')], default='BAG',
                                          max_length=7)),
                ('chosen_period',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('FULFILLED', 'Fulfilled'), ('REJECTED', 'Rejected'), ('PENDING', 'Pending'),
                                           ('REFUNDED', 'Refunded'), ('DISPUTED_AS_FRAUD', 'Disputed as fraud')],
                                  default='PENDING',
                                  max_length=17)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('DRAFT', 'Draft'), ('ACTIVE', 'Active'), ('UNLISTED', 'Unlisted'),
