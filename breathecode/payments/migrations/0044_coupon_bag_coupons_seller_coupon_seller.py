    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_type',
                 models.CharField(choices=[('NO_DISCOUNT', 'No discount'), ('PERCENT_OFF', 'Percent off'),
                                           ('FIXED_PRICE', 'Fixed price'), ('HAGGLING', 'Haggling')],
                                  db_index=True,
                                  default='PERCENT_OFF',
                                  max_length=13)),
                ('discount_value', models.FloatField(help_text="if type is PERCENT_OFF it's a percentage (range 0-1)")),
                ('referral_type',
                 models.CharField(choices=[('NO_REFERRAL', 'No referral'), ('PERCENTAGE', 'Percentage'),
                ...
                ('plans',
                 models.ManyToManyField(
                     blank=True,
                     help_text=
                     'Available plans, if refferal type is not NO_REFERRAL it should keep empty, so, in this case, all plans will be available',
                     to='payments.plan')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type',
                 models.CharField(choices=[('INDIVIDUAL', 'Individual'), ('BUSINESS', 'Business')],
                                  db_index=True,
                                  default='INDIVIDUAL',
                                  max_length=13)),
