...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='bag',
            name='academy',
            field=models.ForeignKey(help_text='Academy owner',
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to='admissions.academy'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='bag',
            name='currency',
            field=models.ForeignKey(help_text='Currency',
                                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            model_name='bag',
            name='type',
            field=models.CharField(choices=[('BAG', 'Bag'), ('CHARGE', 'Charge'), ('PREVIEW', 'Preview')],
                                   default='BAG',
                                   help_text='Bag type',
                                   max_length=7),
        ),
        migrations.AlterField(
            model_name='bag',
            name='user',
            field=models.ForeignKey(help_text='Customer',
                                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            model_name='consumable',
            name='unit_type',
            field=models.CharField(choices=[('UNIT', 'Unit')],
                                   default='UNIT',
        ...
        migrations.AlterField(
            ...
            name='consumable',
            field=models.ForeignKey(help_text='Consumable',
                                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                default=None,
                help_text=
                "Related slug, it's human-readable identifier, it must be unique and it can only contain letters, numbers and hyphens",
                max_length=200,
                null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='currency',
            name='name',
            field=models.CharField(help_text='Currency name (e.g. US Dollar, Euro, Mexican Peso)',
                                   max_length=20,
                                   unique=True),
        ),
        migrations.AlterField(
            ...
            name='in_4geeks',
            field=models.CharField(choices=[('FULFILLED', 'Fulfilled'), ('REJECTED', 'Rejected'),
        ...
        migrations.AlterField(
            model_name='financialreputation',
            name='user',
            field=models.OneToOneField(help_text='Customer',
                                       on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            model_name='invoice',
            name='currency',
            field=models.ForeignKey(help_text='Currency of the invoice',
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to='payments.currency'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                help_text=
                'Valid until, before this date each month the customer must pay, after this date the plan financing will be destroyed and if it is belonging to a cohort, the certificate will be issued after pay every installments'
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='original_plan',
                                    to='payments.plan'),
        ),
        migrations.AlterField(
            model_name='planoffer',
            name='suggested_plans',
            field=models.ManyToManyField(help_text='Suggested plans',
        ...
        migrations.AlterField(
            model_name='planoffertranslation',
            name='offer',
            field=models.ForeignKey(help_text='Plan offer',
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to='payments.planoffer'),
        ),
        migrations.AlterField(
            model_name='planoffertranslation',
        ...
        migrations.AlterField(
            model_name='planserviceitem',
            name='service_item',
            field=models.ForeignKey(help_text='Service item',
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to='payments.serviceitem'),
        ),
        migrations.AlterField(
            ...
            name='handler',
            field=models.ForeignKey(help_text='Plan service item',
                                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            model_name='serviceitem',
            name='service',
            field=models.ForeignKey(help_text='Service',
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to='payments.service'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='subscriptionserviceitem',
            name='subscription',
            field=models.ForeignKey(help_text='Subscription',
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to='payments.subscription'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type_set',
                 models.ForeignKey(help_text='Event type set',
                                   on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True,
                                         help_text='Selected event type sets for the plans of services',
                                         to='payments.EventTypeSet'),
        ),
        migrations.AddField(
            model_name='planfinancing',
