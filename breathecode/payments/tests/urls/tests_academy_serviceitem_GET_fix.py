...
tests_to_fix = [
    ...
    ("renew_at_unit", [("renew_at_unit", ["MONTH", "WEEK"]), ("how_many", [10, 20])], "renew_at_unit=week", "renew_at_unit", "WEEK"),
    ...
    ("unit_type", [("unit_type", ["UNIT", "CREDIT"]), ("how_many", [10, 20])], "unit_type=credit", "unit_type", "CREDIT"),
    ("multiple_unit_types", [("unit_type", ["UNIT", "CREDIT", "LICENSE"]), ("how_many", [10, 20, 30])], "unit_type=unit,credit", None, None),
]
...
def generate_test(name, attrs_list, query, assert_field, assert_value):
    ...
    for i in range(test_items):
        item_setup = [
            f"        model.service_item[{i}].service = model.service"
        ]
