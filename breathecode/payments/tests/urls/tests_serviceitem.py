...
class SignalTestSuite(PaymentsTestCase):
    ...
    def test__without_auth__with_service_items(self):
        ...
        json = response.json()
        expected = [
            get_serializer(model.service_item[1],
                           model.service, [model.service_item_feature[2], model.service_item_feature[3]],
                           data={}),
            get_serializer(model.service_item[0],
                           model.service, [model.service_item_feature[0], model.service_item_feature[1]],
                           data={}),
        ]
    ...
    def test__without_auth__filtering_by_lang(self):
        ...
        json = response.json()
        expected = [
            get_serializer(model.service_item,
                           model.service, [model.service_item_feature[0], model.service_item_feature[1]],
                           data={}),
        ]
