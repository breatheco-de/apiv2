...
urlpatterns = [
    ...
    path('me/service/<str:service_slug>/consume/<str:hash>', ConsumeView.as_view(),
         name='me_service_slug_consume_hash'),
    path('me/service/<str:service_slug>/cancel/<str:hash>',
