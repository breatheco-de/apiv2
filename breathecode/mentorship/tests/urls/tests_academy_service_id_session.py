...
class AcademyServiceTestSuite(MentorshipTestCase):
    ...
    def test__get__with_two_mentor_profile__passing_bad_status(self):
        ...
        for n in range(0, 4):
            ...
            url = (
                reverse_lazy("mentorship:academy_service_id_session", kwargs={"service_id": 1})
    ...
    def test__get__with_two_mentor_profile__passing_status(self):
        ...
        for n in range(0, 4):
            ...
            url = (
                reverse_lazy("mentorship:academy_service_id_session", kwargs={"service_id": model.mentor_profile.id})
    ...
    def test__get__with_two_mentor_profile__passing_billed_as_true__without_mentorship_bill(self):
        ...
        url = reverse_lazy("mentorship:academy_service_id_session", kwargs={"service_id": 1}) + f"?billed=true"
        response = self.client.get(url)
    ...
    def test__get__with_two_mentor_profile__passing_billed_as_false__with_mentorship_bill(self):
        ...
        url = reverse_lazy("mentorship:academy_service_id_session", kwargs={"service_id": 1}) + f"?billed=false"
        response = self.client.get(url)
