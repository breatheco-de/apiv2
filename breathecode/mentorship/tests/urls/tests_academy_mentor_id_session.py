...
class AcademyServiceTestSuite(MentorshipTestCase):
    ...
    def test__get__with_two_mentor_profile(self):
        ...
        expected = [
            get_serializer(
                self, mentorship_session, model.mentor_profile, model.mentorship_service, model.user, data={}
            )
    ...
    def test__get__with_two_mentor_profile__passing_bad_status(self):
        ...
        for n in range(0, 4):
            ...
            url = (
                reverse_lazy("mentorship:academy_mentor_id_session", kwargs={"mentor_id": 1})
    ...
    def test__get__with_two_mentor_profile__passing_status(self):
        ...
        for n in range(0, 4):
            ...
            url = (
                reverse_lazy("mentorship:academy_mentor_id_session", kwargs={"mentor_id": model.mentor_profile.id})
    ...
    def test__get__with_two_mentor_profile__passing_billed_as_true__without_mentorship_bill(self):
        ...
        url = reverse_lazy("mentorship:academy_mentor_id_session", kwargs={"mentor_id": 1}) + f"?billed=true"
        response = self.client.get(url)
    ...
    def test__get__with_two_mentor_profile__passing_billed_as_false__with_mentorship_bill(self):
        ...
        url = reverse_lazy("mentorship:academy_mentor_id_session", kwargs={"mentor_id": 1}) + f"?billed=false"
        response = self.client.get(url)
    ...
    def test__get__with_two_mentor_profile__passing_started_after__without_started_at(self):
        ...
        for case in cases:
            url = (
                reverse_lazy("mentorship:academy_mentor_id_session", kwargs={"mentor_id": 1}) + f"?started_after={case}"
            )
            response = self.client.get(url)
    ...
    def test__get__with_two_mentor_profile__passing_ended_before__without_ended_at(self):
        ...
        for case in cases:
            url = (
                reverse_lazy("mentorship:academy_mentor_id_session", kwargs={"mentor_id": 1}) + f"?ended_before={case}"
            )
            response = self.client.get(url)
