    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('INVITED', 'Invited'), ('ACTIVE', 'Active'),
                                           ('INNACTIVE', 'Innactive')],
                                  default='INVITED',
            ...
            fields=[
                ...
                ('online_recording_url',
                 models.CharField(
                     ...
                     default=None,
                     help_text=
                     'We encourace the mentors to record the session and share them with the students',
                     max_length=255,
                     null=True)),
                ('status',
                 models.CharField(choices=[('INVITED', 'Invited'), ('ACTIVE', 'Active'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=150)),
                ('status',
                 models.CharField(choices=[('DRAFT', 'Draft'), ('ACTIVE', 'Active'),
                                           ('INNACTIVE', 'Innactive')],
                                  default='DRAFT',
                                  max_length=15)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
