    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('INVITED', 'Invited'), ('ACTIVE', 'Active'), ('INNACTIVE', 'Innactive')],
                                  default='INVITED',
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('INVITED', 'Invited'), ('ACTIVE', 'Active'), ('INNACTIVE', 'Innactive')],
                                  ...
                                  max_length=15)),
                ('agenda',
                 models.TextField(blank=True, default=None, help_text='What will this mentorship be about', null=True)),
                ('summary',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=150)),
                ('status',
                 models.CharField(choices=[('DRAFT', 'Draft'), ('ACTIVE', 'Active'), ('INNACTIVE', 'Innactive')],
                                  default='DRAFT',
                                  max_length=15)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.AddField(
            model_name='mentorprofile',
            name='user',
            field=models.ForeignKey(help_text='If the user does not exist, you can use the email field instead',
