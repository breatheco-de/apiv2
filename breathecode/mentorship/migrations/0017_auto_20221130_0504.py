    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slack_channel',
                 models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='notify.slackchannel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token',
                 models.CharField(help_text='Used for inviting the user to become a support agent',
                                  max_length=255,
                                  unique=True)),
                ('status',
                 models.CharField(choices=[('INVITED', 'Invited'), ('ACTIVE', 'Active'), ('UNLISTED', 'Unlisted'),
                                           ('INNACTIVE', 'Innactive')],
                                  default='INVITED',
                                  help_text='Options are: INVITED, ACTIVE, UNLISTED, INNACTIVE',
                                  max_length=15)),
                ...
                ('user',
                 models.ForeignKey(help_text='If the user does not exist, you can use the email field instead',
