...
from .views import (forward_booking_url, forward_booking_url_by_service, forward_meet_url,
                    end_mentoring_session, pick_mentorship_service)

app_name = 'mentorship'
urlpatterns = [
    path('<slug:mentor_slug>', forward_booking_url, name='slug'),
    path('<slug:mentor_slug>/service/<slug:service_slug>',
