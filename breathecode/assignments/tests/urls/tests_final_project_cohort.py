...
def get_serializer(final_project, data={}):
    return {
        ...
        } if final_project.repo_owner else None,
        ...
        'cohort': {
            'id': final_project.cohort.id,
            'name': final_project.cohort.name,
            'slug': final_project.cohort.slug
        } if final_project.cohort else None,
