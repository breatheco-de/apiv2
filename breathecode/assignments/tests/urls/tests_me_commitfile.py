...
class MediaTestSuite(AssignmentsTestCase):
    ...
    def test_no_auth(self):
        url = reverse_lazy('assignments:me_commitfile')
    ...
    def test__get__auth(self):
        ...
        url = reverse_lazy('assignments:me_commitfile') + '?' + self.bc.format.querystring(query)
        ...
        with patch.multiple('breathecode.utils.service.Service',
            ...
            self.bc.check.calls(Service.get.call_args_list, [
                call('/v1/finetuning/commitfile', params=query, stream=True),
            ])
