...
class MediaTestSuite(AssignmentsTestCase):
    ...
    @patch("logging.Logger.info", MagicMock())
    def test__sync_cohort_user_marks_exercise_done_from_existing_telemetry(self):
        ...
        syllabus_json = {
            "days": [
                {
                    "lessons": [],
                    "replits": [{"slug": "speaking-with-ai", "title": "Speaking"}],
                    "assignments": [],
                    "quizzes": [],
                }
            ],
        ...
        sync_cohort_user_tasks.delay(model.cohort_user.id)
    ...
    @patch("logging.Logger.info", MagicMock())
    def test__sync_cohort_user_heals_existing_pending_exercise_from_telemetry(self):
        from breathecode.assignments.models import AssignmentTelemetry, Task
