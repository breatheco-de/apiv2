    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("career_tags", models.ManyToManyField(blank=True, to="career.careertag")),
                (
                    "employer",
                    models.ForeignKey(
                ...
                ("locations", models.ManyToManyField(blank=True, to="career.location")),
                ("position", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="career.position")),
        ...
        migrations.AddField(
            model_name="spider",
            name="zyte_project",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="career.zyteproject"),
        ),
    ]
