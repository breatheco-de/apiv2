    ...
    operations = [
            ...
            fields=[
                ...
                ('loc_search',
                 models.CharField(blank=True,
                                  ...
                                  null=True)),
                ('zyte_spider_number',
                 models.IntegerField(blank=True, default=0, help_text='This number must be copy from ZYTE', null=True)),
                ('zyte_job_number',
                 models.IntegerField(blank=True,
                                     default=0,
                ...
                ('spider_last_run_status',
                 models.CharField(choices=[('SYNCHED', 'Synched'), ('PENDING', 'Pending'), ('WARNING', 'Warning'),
                                           ('ERROR', 'Error')],
                                  default='PENDING',
                                  max_length=15)),
                ...
                ('zyte_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                   to='career.zyteproject')),
            ],
        ),
        migrations.CreateModel(
            name='PositionAlias',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('OPENED', 'Opened'), ('FILLED', 'Filled')], default='OPENED',
                                  max_length=15)),
