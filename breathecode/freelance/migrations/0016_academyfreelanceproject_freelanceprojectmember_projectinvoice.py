    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status',
                 models.CharField(choices=[('DUE', 'Due'), ('APPROVED', 'Approved'), ('IGNORED', 'Ignored'),
                                           ('PAID', 'Paid')],
                                  default='DUE',
                                  max_length=20)),
                ...
                ('freelancer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                 to='freelance.freelancer')),
                ('project',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='freelance.freelanceprojectmember')),
                ('reviewer',
