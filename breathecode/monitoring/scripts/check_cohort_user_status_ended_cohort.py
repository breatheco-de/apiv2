...
active_user_on_ended_cohort = CohortUser.objects.filter(cohort__stage='ENDED',
...
if len(active_user_on_ended_cohort_list):
    raise ScriptNotification(f'This users: {active_user_on_ended_cohort_list_names} are active on ended cohorts',
