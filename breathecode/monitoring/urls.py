...
from .views import (
    ...
    AcademyScriptView,
    DjangoAdminView,
    MonitoringReportDetailView,
    MonitoringReportGenerationDetailView,
    MonitoringReportGenerationListView,
    MonitoringReportGenerationView,
    MonitoringReportSummaryView,
...
urlpatterns = [
    ...
    path("report", MonitoringReportView.as_view(), name="report_types"),
    path("report/generate-jobs", MonitoringReportGenerationListView.as_view(), name="report_generate_jobs"),
    path("report/<str:report_type>", MonitoringReportView.as_view(), name="report_type"),
    path("report/<str:report_type>/summary", MonitoringReportSummaryView.as_view(), name="report_type_summary"),
    path("report/<str:report_type>/<int:report_id>", MonitoringReportDetailView.as_view(), name="report_type_id"),
    path("report/<str:report_type>/generate", MonitoringReportGenerationView.as_view(), name="report_type_generate"),
    path("report/<str:report_type>/generate/<int:job_id>", MonitoringReportGenerationDetailView.as_view(), name="report_type_generate_id"),
