...
# @pytest.mark.parametrize('task_module, code, error', [
#     ('x', 'all_ok_supervisor', 'Module x not found'),
#     ('breathecode.monitoring.tests.tasks.tests_fix_issue', 'x',
#      'Supervisor breathecode.monitoring.tests.tasks.tests_fix_issue.x not found'),
# ])
# def tests_supervisor_handler_not_found(database: capy.Database, format: capy.Format, error: str, task_module: str,
#                                        code: str):
#     task_name = 'my_supervisor'
#     model = database.create(supervisor={
#         'task_module': task_module,
...
# def tests_issue_returns_x(database: capy.Database, format: capy.Format,
#                           res: str, utc_now: datetime):
#     model = database.create(supervisor={
#         'task_module': 'breathecode.monitoring.tests.tasks.tests_fix_issue',
#         'task_name': 'my_supervisor',
#         'delta': timedelta(days=1),
