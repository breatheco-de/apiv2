    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_status_text', models.CharField(blank=True, default=None, help_text='Add a message for people to see when is down', max_length=255, null=True)),
                ...
                ('status', models.CharField(choices=[('OPERATIONAL', 'Operational'), ('MINOR', 'Minor'), ('CRITICAL', 'Critical')], default='OPERATIONAL', max_length=20)),
                ('paused_until', models.DateTimeField(blank=True, default=None, help_text='if you want to stop checking for a period of time', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitoring.application')),
            ],
        ),
    ]
