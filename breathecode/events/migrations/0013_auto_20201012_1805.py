    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sync_status', models.CharField(choices=[('PENDING', 'Pending'), ('PERSISTED', 'Persisted'), ('ERROR', 'Error')], default='PENDING', help_text='One of: PENDING, PERSISTED or ERROR depending on how the eventbrite sync status', max_length=9)),
