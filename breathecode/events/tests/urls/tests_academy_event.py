...
class AcademyEventTestSuite(EventTestCase):
    ...
    def test_all_academy_events_get_with_event_is_public_true_in_filter_is_public_true(self):
        self.headers(academy=1)
        ...
        url = reverse_lazy("events:academy_event") + "?is_public=true"
    ...
    def test_all_academy_events_get_with_event_is_public_true_in_filter_is_public_false(self):
        self.headers(academy=1)
        event_kwargs = {"is_public": True}
        model = self.generate_models(
            authenticate=True,
        ...
        url = reverse_lazy("events:academy_event") + "?is_public=false"
    ...
    def test_all_academy_events_get_with_event_is_public_false_in_filter_is_public_false(self):
        self.headers(academy=1)
    ...
    def test_all_academy_events_get_with_event_is_public_false_in_filter_is_public_true(self):
        self.headers(academy=1)
        event_kwargs = {"is_public": False}
        model = self.generate_models(
            authenticate=True,
