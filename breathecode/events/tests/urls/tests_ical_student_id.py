...
class AcademyCohortTestSuite(EventTestCase):
    ...
    def test_ical_cohorts__with_one__cohort_without_ending_date(self):
        ...
        model = self.generate_models(
            academy=True, device_id=device_id_kwargs, cohort_user=1, cohort_time_slot=cohort_time_slot_kwargs, cohort=1
        )
    ...
    def test_ical_cohorts__with_one__with_ending_date(self):
        ...
        starting_at_utc = self.datetime_to_ical(
            DatetimeInteger.to_utc_datetime(model.cohort_time_slot.timezone, model.cohort_time_slot.starting_at),
            utc=True,
        )
    ...
    def test_ical_cohorts__with_one__without_ending_date(self):
        ...
        created_at = self.datetime_to_ical(
            DatetimeInteger.to_utc_datetime(model.cohort_time_slot.timezone, model.cohort_time_slot.starting_at),
            utc=True,
        )
    ...
    def test_ical_cohorts__with_one__with_incoming_true(self):
        ...
        cohort_kwargs = {
            ...
            "ending_date": datetime(
                year=2060, day=31, month=12, hour=12, minute=0, second=0, tzinfo=pytz.timezone("UTC")
            ),
        }
    ...
    def test_ical_cohorts__with_one__with_teacher(self):
        ...
        starting_at = self.datetime_to_ical(
            fix_datetime_weekday(
                model1.cohort.kickoff_date,
                DatetimeInteger.to_datetime(model1.cohort_time_slot.timezone, model1.cohort_time_slot.starting_at),
                next=True,
            ),
            utc=False,
        )
        ...
        starting_at_utc = self.datetime_to_ical(
            DatetimeInteger.to_utc_datetime(model1.cohort_time_slot.timezone, model1.cohort_time_slot.starting_at),
            utc=True,
        )
    ...
    def test_ical_cohort__with_two__with_teacher(self):
        ...
        models = [
            self.generate_models(
                cohort_user=True, cohort_time_slot=True, cohort_time_slot_kwargs=cohort_time_slot_kwargs, models=base
            ),
        ...
        starting_at3 = self.datetime_to_ical(
            fix_datetime_weekday(
                model3.cohort.kickoff_date,
                DatetimeInteger.to_datetime(model3.cohort_time_slot.timezone, model3.cohort_time_slot.starting_at),
                next=True,
            ),
            utc=False,
        )
        ...
        starting_at_utc3 = self.datetime_to_ical(
            DatetimeInteger.to_utc_datetime(model3.cohort_time_slot.timezone, model3.cohort_time_slot.starting_at),
            utc=True,
        )
