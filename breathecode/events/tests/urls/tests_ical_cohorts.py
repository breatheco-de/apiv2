...
class AcademyCohortTestSuite(EventTestCase):
    ...
    def test_ical_cohorts__with_one(self):
        ...
        expected = '\r\n'.join([
            ...
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort.kickoff_date)}',
    ...
    def test_ical_cohorts__with_one__with_teacher__with_ending_date(self):
        ...
        expected = '\r\n'.join([
            ...
            f'SUMMARY:{cohort.name}',
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort.kickoff_date)}',
            f'DTEND;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort.ending_date)}',
            f'DTSTAMP;VALUE=DATE-TIME:{self.datetime_to_ical(cohort.created_at)}',
            f'UID:breathecode_cohort_{cohort.id}_{key}',
            f'LOCATION:{academy.name}',
            self.line_limit(
    ...
    def test_ical_cohorts__with_two(self):
        ...
        expected = '\r\n'.join([
            ...
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort1.kickoff_date)}',
            ...
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort2.kickoff_date)}',
    ...
    def test_ical_cohorts__with_two__with_teacher__with_ending_date(self):
        ...
        expected = '\r\n'.join([
            ...
            f'SUMMARY:{cohort1.name}',
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort1.kickoff_date)}',
            f'DTEND;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort1.ending_date)}',
            f'DTSTAMP;VALUE=DATE-TIME:{self.datetime_to_ical(cohort1.created_at)}',
            f'UID:breathecode_cohort_{cohort1.id}_{key}',
            f'LOCATION:{academy1.name}',
            self.line_limit(
            ...
            f'SUMMARY:{cohort2.name}',
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort2.kickoff_date)}',
            f'DTEND;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort2.ending_date)}',
            f'DTSTAMP;VALUE=DATE-TIME:{self.datetime_to_ical(cohort2.created_at)}',
            f'UID:breathecode_cohort_{cohort2.id}_{key}',
            f'LOCATION:{academy2.name}',
            self.line_limit(
    ...
    def test_ical_cohorts__with_two__with_teacher__with_ending_date__with_two_academies_id(self):
        ...
        expected = '\r\n'.join([
            ...
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort3.kickoff_date)}',
            f'DTEND;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort3.ending_date)}',
            ...
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort4.kickoff_date)}',
            f'DTEND;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(cohort4.ending_date)}',
    ...
    def test_ical_cohorts__with_one__first_day(self):
        ...
        expected = '\r\n'.join([
            ...
            f'DTSTART;TZID=Europe/Madrid;VALUE=DATE-TIME:{starting_at}',
            f'DTEND;TZID=Europe/Madrid;VALUE=DATE-TIME:{ending_at}',
    ...
    def test_ical_cohorts__with_one__first_day__last_day(self):
        ...
        expected = '\r\n'.join([
            ...
            f'DTSTART;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(last_timeslot_starting_at)}',
            f'DTEND;TZID=UTC;VALUE=DATE-TIME:{self.datetime_to_ical(last_timeslot_ending_at)}',
            f'DTSTAMP;VALUE=DATE-TIME:{self.datetime_to_ical(timeslot.created_at)}',
