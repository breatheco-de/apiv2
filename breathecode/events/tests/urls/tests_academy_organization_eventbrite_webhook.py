...
class AcademyEventbriteWebhookTestSuite(EventTestCase):
    ...
    def test_all_eventbrite_webhooks_no_auth(self):
        ...
        model = self.bc.database.create(
            eventbrite_webhook=eventbrite_webhook,
            profile_academy=1,
            organization=1,
        ...
        expected = [
            {
                ...
                "attendee": model["eventbrite_webhook"].attendee,
                "event": model["eventbrite_webhook"].event,
                "payload": model["eventbrite_webhook"].payload,
