...
class Organization(models.Model):
    ...
    academy = models.ForeignKey(
        Academy, on_delete=models.CASCADE, blank=True, null=True)
    eventbrite_key = models.CharField(
        max_length=255, blank=True, null=True, default=None)
    name = models.CharField(max_length=100, blank=True, null=True, default='')

    sync_status = models.CharField(max_length=9, choices=SYNC_STATUS, default=PENDING,
                                   help_text="One of: PENDING, PERSISTED or ERROR depending on how the eventbrite sync status")
    sync_desc = models.TextField(
...
class Venue(models.Model):
    ...
    street_address = models.CharField(
        max_length=250, blank=True, default=None, null=True)
    ...
    longitude = models.DecimalField(
        max_digits=20, decimal_places=15, default=0)
    state = models.CharField(max_length=30, blank=True,
                             default=None, null=True)
    zip_code = models.IntegerField(blank=True, default=None, null=True)
    status = models.CharField(
        max_length=9, choices=VENUE_STATUS, default=DRAFT)
    academy = models.ForeignKey(
        Academy, on_delete=models.CASCADE, blank=True, null=True)
    ...
    eventbrite_id = models.CharField(
        unique=True, max_length=80, blank=True, default=None, null=True)
    eventbrite_url = models.CharField(
...
class Event(models.Model):
    description = models.TextField(
        max_length=2000, blank=True, default=None, null=True)
    excerpt = models.TextField(
        max_length=500, blank=True, default=None, null=True)
    title = models.CharField(
        max_length=255, blank=True, default=None, null=True)
    ...
    host = models.ForeignKey(
        User, on_delete=models.SET_NULL, related_name='host', blank=True, null=True)
    academy = models.ForeignKey(
        Academy, on_delete=models.CASCADE, blank=True, null=True)
    organization = models.ForeignKey(
        Organization, on_delete=models.CASCADE, blank=True, null=True)
    ...
    venue = models.ForeignKey(
        Venue, on_delete=models.CASCADE, null=True, default=None)
    event_type = models.ForeignKey(
        EventType, on_delete=models.SET_NULL, null=True, default=None)
    ...
    eventbrite_organizer_id = models.CharField(
        max_length=80, blank=True, default=None, null=True)

    status = models.CharField(
        max_length=9, choices=EVENT_STATUS, default=DRAFT, blank=True)
    eventbrite_status = models.CharField(
        max_length=9, help_text="One of: draft, live, started, ended, completed and canceled", blank=True, default=None, null=True)
...
class EventCheckin(models.Model):
    ...
    status = models.CharField(
        max_length=9, choices=CHECKIN_STATUS, default=PENDING)
...
class EventbriteWebhook(models.Model):
    ...
    status = models.CharField(
        max_length=9, choices=EVENTBRITE_WEBHOOK_STATUS, default=PENDING)
