...
urlpatterns = [
    ...
    path(
        "academy/event/<int:event_id>/recording",
        AcademyEventRecordingView.as_view(),
        name="academy_event_id_recording",
    ),
    ...
    path("ical/student/me", ICalStudentMeView.as_view(), name="ical_student_me"),
