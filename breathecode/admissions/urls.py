...
from .views import (AcademyView, CohortUserView, AcademyCohortView, SyllabusVersionView, SyllabusView,
                    ...
                    CertificateSyllabusVersionView, CertificateView, CertificateAllView, get_all_academies,
                    get_cohorts, AcademyCohortTimeSlotView, AcademySpecialtyModeTimeSlotView,
...
urlpatterns = [
    ...
    path('certificate/<str:certificate_slug>/syllabus',
         CertificateSyllabusVersionView.as_view(),
