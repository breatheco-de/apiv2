            ...
            expected = [
                {
                    ...
                    "timeslots": (
                        [
                            {
                                "ending_at": self.integer_to_iso(
                                    cohort_time_slot["timezone"], cohort_time_slot["ending_at"]
                                ),
                                ...
                                "starting_at": self.integer_to_iso(
                                    cohort_time_slot["timezone"], cohort_time_slot["starting_at"]
                                ),
                            }
                        ]
                        if cohort_time_slots and model.cohort.id != 1
                        else []
                    ),
                    "schedule": {
