...
class CertificateTestSuite(AdmissionsTestCase):
    ...
    def test_syllabus_slug_version_version_without_auth(self):
        ...
        url = reverse_lazy(
            "admissions:syllabus_slug_version_version", kwargs={"syllabus_slug": "they-killed-kenny", "version": 1}
        )
    ...
    def test_syllabus_slug_version_version(self):
        ...
        url = reverse_lazy(
            "admissions:syllabus_slug_version_version",
            kwargs={"syllabus_slug": "they-killed-kenny", "version": model.syllabus_version.version},
        )
        response = self.client.get(url)
        json = response.json()
        expected = {
