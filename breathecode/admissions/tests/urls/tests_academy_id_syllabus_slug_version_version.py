...
class CertificateTestSuite(AdmissionsTestCase):
    ...
    def test_academy_id_syllabus_slug_version_version_without_auth(self):
        """Test /certificate without auth"""
        self.headers(academy=1)
        url = reverse_lazy(
            "admissions:academy_id_syllabus_slug_version_version",
            kwargs={"academy_id": 1, "syllabus_slug": "they-killed-kenny", "version": 1},
        )
    ...
    def test_academy_id_syllabus_slug_version_version_without_capability(self):
        """Test /certificate without auth"""
        self.headers(academy=1)
        url = reverse_lazy(
            "admissions:academy_id_syllabus_slug_version_version",
    ...
    def test_academy_id_syllabus_slug_version_version(self):
        ...
        url = reverse_lazy(
            "admissions:academy_id_syllabus_slug_version_version",
            kwargs={"academy_id": 1, "syllabus_slug": "they-killed-kenny", "version": model.syllabus_version.version},
        )
        response = self.client.get(url)
        json = response.json()
        expected = {
