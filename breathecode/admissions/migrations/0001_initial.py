    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage',
                 models.CharField(choices=[('INACTIVE', 'Inactive'), ('PREWORK', 'Prework'), ('STARTED', 'Started'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role',
                 models.CharField(choices=[('TEACHER', 'Teacher'), ('ASSISTANT', 'Assistant'), ('STUDENT', 'Student')],
                                  default='STUDENT',
                                  max_length=9)),
                ('finantial_status',
                 models.CharField(choices=[('FULLY_PAID', 'Fully Paid'), ('UP_TO_DATE', 'Up to date'),
                                           ('LATE', 'Late')],
                                  default=None,
                                  max_length=15,
                                  null=True)),
                ('educational_status',
                 models.CharField(choices=[('ACTIVE', 'Active'), ('POSTPONED', 'Postponed'), ('GRADUATED', 'Graduated'),
                                           ('DROPPED', 'Dropped')],
                                  default=None,
                                  max_length=15,
                                  null=True)),
