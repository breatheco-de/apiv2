    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage',
                 models.CharField(choices=[('INACTIVE', 'Inactive'), ('PREWORK', 'Prework'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id',
                 models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role',
                 models.CharField(choices=[('TEACHER', 'Teacher'), ('ASSISTANT', 'Assistant'),
                                           ('STUDENT', 'Student')],
                                  default='STUDENT',
                                  max_length=9)),
                ('finantial_status',
                 models.CharField(choices=[('FULLY_PAID', 'Fully Paid'), ('UP_TO_DATE', 'Up to date'),
                                  ...
                                  null=True)),
                ('educational_status',
                 models.CharField(choices=[('ACTIVE', 'Active'), ('POSTPONED', 'Postponed'),
