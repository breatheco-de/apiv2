...
from ..views import CategoryView, MaskingUrlView, MediaView, ResolutionView, UploadView
...
urlpatterns = [
    ...
    path("resolution/<int:resolution_id>", resolution_by_id_view, name="resolution_id"),
    path("file/<int:media_id>", MaskingUrlView.as_view(), name="file_id"),
    path("file/<str:media_slug>", MaskingUrlView.as_view(), name="file_slug"),
    path("upload", UploadView.as_view(), name="upload"),
    path("category", category_view, name="category"),
    path("category/<int:category_id>", category_by_id_view, name="category_id"),
    path("category/<str:category_slug>", category_by_slug_view, name="category_slug"),
]
