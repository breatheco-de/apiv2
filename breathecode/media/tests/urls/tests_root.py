...
class MediaTestSuite(MediaTestCase):
    ...
    def test_root__with_category__with_two_academy_in_querystring(self):
        ...
        ordened_models = sorted(models,
                                key=lambda x: x['media'].created_at,
                                reverse=True)
    ...
    def test_root__with_category__with_two_mime_in_querystring(self):
        ...
        url = reverse_lazy('media:root') + '?mime=' + models[0][
            'media'].mime + ',' + models[1]['media'].mime
        response = self.client.get(url)
        json = response.json()
        self.assertEqual(json, [{
            'categories': [{
    ...
    def test_root__with_category__with_two_name_in_querystring(self):
        ...
        url = (reverse_lazy('media:root') + '?name=' +
               models[0]['media'].name + ',' + models[1]['media'].name)
        response = self.client.get(url)
        json = response.json()
        self.assertEqual(json, [{
            'categories': [{
    ...
    def test_root__with_category__with_two_slug_in_querystring(self):
        ...
        url = (reverse_lazy('media:root') + '?slug=' +
               models[0]['media'].slug + ',' + models[1]['media'].slug)
        response = self.client.get(url)
        json = response.json()
        self.assertEqual(json, [{
            'categories': [{
    ...
    def test_root__with_category__with_two_id_in_querystring(self):
        ...
        url = (reverse_lazy('media:root') + '?id=' +
               str(models[0]['media'].id) + ',' + str(models[1]['media'].id))
        response = self.client.get(url)
        json = response.json()
        self.assertEqual(json, [{
            'categories': [{
    ...
    def test_root__with_category__with_two_categories_in_querystring(self):
        ...
        categories = [
            self.generate_models(category=True).category for _ in range(0, 2)
        ]
