...
class MediaTestSuite(MediaTestCase):
    ...
    def test_upload(self):
        ...
        with open(file.name, 'rb') as data:
            ...
            expected = [{
                ...
                'filename-png',
                'thumbnail':
                'https://storage.cloud.google.com/media-breathecode/hardcoded_url-thumbnail',
                'url':
                'https://storage.cloud.google.com/media-breathecode/hardcoded_url'
            }]
    ...
    def test_upload_categories_in_headers___(self):
        ...
        data = {
            'name': ['filename1.jpg', 'filename2.jpg'],
            'file': [file1, file2]
        }
        response = self.client.put(url, data, format='multipart')
        json = response.json()
