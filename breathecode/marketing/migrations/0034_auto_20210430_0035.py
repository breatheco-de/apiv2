    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initiated_by',
                 models.CharField(help_text='Source/section of the software that triggered the webhook to run',
                                  max_length=100)),
                ('payload',
                 models.JSONField(
                ...
                ('ac_academy',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketing.activecampaignacademy')),
                ('contact',
