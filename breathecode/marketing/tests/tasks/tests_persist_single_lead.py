...
class AnswerIdTestSuite(MarketingTestCase):
    ...
    # def test_register_new_lead_without_form_data(self):
    ...
    #             }]
    #         })]))
    # def test_persist_single_lead_with_form_entry_with_data_current_download(self):
    #     """Test /answer/:id without auth"""
    #     mock_mailgun = MAILGUN_INSTANCES['post']
    #     mock_mailgun.call_args_list = []
    ...
    # def test_persist_single_lead_task(self):
    #     """Test /answer/:id without auth"""
    ...
    #     form_entry_db = self.model_to_dict(model, 'form_entry')

    #     persist_single_lead.delay(1)
    #     self.assertEqual(persist_single_lead.delay.call_args_list, [call(1)])
    #     self.assertEqual(self.all_form_entry_dict(), [form_entry_db])
