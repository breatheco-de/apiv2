...
from .views import (create_lead, sync_tags_with_active_campaign,
                    ...
                    AcademyLeadView, AcademyWonLeadView, AcademyTagView,
                    AcademyAutomationView, activecampaign_webhook,
                    googleads_enrollments, googleads_csv)
...
urlpatterns = [
    ...
    path('academy/lead/won',
         AcademyWonLeadView.as_view(),
         name='academy_won_lead'),
