...
urlpatterns = [
    ...
    path("crmacademy", CrmAcademyView.as_view(), name="crm_academy"),
    path("crmacademy/<int:crm_academy_id>", CrmAcademyView.as_view(), name="crm_academy_id"),
    # Deprecated aliases — remove in a future release
    path("activecampaign", CrmAcademyView.as_view(), name="activecampaign"),
    path("activecampaign/<int:crm_academy_id>", CrmAcademyView.as_view(), name="activecampaign_id"),
