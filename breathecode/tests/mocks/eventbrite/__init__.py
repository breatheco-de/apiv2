...
from .constants import (EVENTBRITE_EVENT, EVENTBRITE_ORDER, EVENTBRITE_ATTENDEE,
    EVENTBRITE_TICKET_CLASS, EVENTBRITE_EVENT_URL, EVENTBRITE_ORDER_URL, EVENTBRITE_ATTENDEE_URL,
...
EVENTBRITE_INSTANCES = {
    'get': Mock(side_effect=request_mock)
}
