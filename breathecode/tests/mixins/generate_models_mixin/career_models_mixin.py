...
class CareerModelsMixin(ModelsMixin):
    ...
    def generate_career_models(self,
        ...
        if not 'zyte_project' in models and (is_valid(zyte_project) or is_valid(spider)):
            ...
            models['zyte_project'] = create_models(zyte_project, 'career.ZyteProject', **{
                **kargs,
                **zyte_project_kwargs
            })
        ...
        if not 'position_alias' in models and is_valid(position_alias):
            ...
            models['position_alias'] = create_models(position_alias, 'career.PositionAlias', **{
                **kargs,
                **position_alias_kwargs
            })
        ...
        if not 'location_alias' in models and is_valid(location_alias):
            ...
            models['location_alias'] = create_models(location_alias, 'career.LocationAlias', **{
                **kargs,
                **location_alias_kwargs
            })
