...
class LinkedServicesMixin(DateFormatterMixin, HeadersMixin, ModelsMixin):
    ...
    def generate_linked_services_models(self,
                                        scope=False,
                                        app=False,
        ...
        if not 'app_required_scope' in models and is_valid(app_required_scope):
            ...
            models['app_required_scope'] = create_models(app_required_scope, 'linked_services.AppRequiredScope',
                                                         **kargs)
        ...
        if not 'app_optional_scope' in models and is_valid(app_optional_scope):
            ...
            models['app_optional_scope'] = create_models(app_optional_scope, 'linked_services.AppOptionalScope',
                                                         **kargs)
        ...
        if not 'optional_scope_set' in models and (is_valid(optional_scope_set) or is_valid(app_user_agreement)):
            ...
            models['optional_scope_set'] = create_models(optional_scope_set, 'linked_services.OptionalScopeSet',
                                                         **kargs)
        ...
        if not 'app_user_agreement' in models and is_valid(app_user_agreement):
            ...
            models['app_user_agreement'] = create_models(app_user_agreement, 'linked_services.AppUserAgreement',
                                                         **kargs)
        ...
        if not 'first_party_credentials' in models and is_valid(first_party_credentials):
            ...
            models['first_party_credentials'] = create_models(first_party_credentials,
                                                              'linked_services.FirstPartyCredentials', **kargs)
        ...
        if not 'first_party_webhook_log' in models and is_valid(first_party_webhook_log):
            ...
            models['first_party_webhook_log'] = create_models(first_party_webhook_log,
                                                              'linked_services.FirstPartyWebhookLog', **kargs)
