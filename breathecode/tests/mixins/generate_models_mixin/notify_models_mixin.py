    ...
    def generate_notify_models(
        ...
        **kwargs
        ...
        if not "slack_user_team" in models and is_valid(slack_user_team):
            ...
            models["slack_user_team"] = create_models(
                slack_user_team, "notify.SlackUserTeam", **{**kargs, **slack_user_team_kwargs}
            )
        ...
        if not "slack_channel" in models and is_valid(slack_channel):
            ...
            models["slack_channel"] = create_models(
                slack_channel, "notify.SlackChannel", **{**kargs, **slack_channel_kwargs}
            )
