...
class Asset(models.Model):
    ...
    visibility = models.CharField(max_length=20, choices=VISIBILITY, default=PUBLIC, help_text='It won\'t be shown on the website unleast the status is published')
