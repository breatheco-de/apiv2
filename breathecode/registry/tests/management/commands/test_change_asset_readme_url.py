...
class ChangeAssetReadmeUrlTestCase(RegistryTestCase):
    ...
    def test_change_asset_readme_url_with_readme(self):
        ...
        readme_url1 = f'https://raw.githubusercontent.com/{random_slug1}/{random_slug2}/{random_slug3}/{random_slug4}.md'
        readme_url2 = f'https://raw.githubusercontent.com/{random_slug4}/{random_slug3}/{random_slug2}/{random_slug1}.md'
        ...
        self.assertEqual(self.bc.database.list_of('registry.Asset'), [{
            **self.bc.format.to_dict(model.asset[0]), 'readme_url':
            f'https://github.com/{random_slug1}/{random_slug2}/blob/{random_slug3}/{random_slug4}.md'
        }, {
            **self.bc.format.to_dict(model.asset[1]), 'readme_url':
            f'https://github.com/{random_slug4}/{random_slug3}/blob/{random_slug2}/{random_slug1}.md'
        }])
    ...
    def test_change_asset_readme_url_without_readmes_to_change(self):
        ...
        asset = {'readme_url': 'https://github.com/breatheco-de/exercise-postcard/blob/main/README.md'}
