...
from ..views import (
    ...
    AcademyAssetErrorDedupeView,
    AcademyAssetErrorView,
    AcademyAssetErrorCatalogView,
    ...
    forward_asset_url,
    get_alias_redirects,
    get_asset_meta_from_readme_url,
    get_categories,
    get_config,
    get_keywords,
    get_translations,
...
urlpatterns = [
    ...
    path("academy/asset/meta_from_readme_url", get_asset_meta_from_readme_url, name="academy_asset_meta_from_readme_url"),
    ...
    path("academy/asset/error/catalog", AcademyAssetErrorCatalogView.as_view()),
    path("academy/asset/error/<str:error_id>/dedupe", AcademyAssetErrorDedupeView.as_view()),
    path("academy/asset/error/<str:error_id>", AcademyAssetErrorView.as_view()),
    path("academy/asset/action/<str:action_slug>", AcademyAssetActionView.as_view(), name="academy_asset_action_slug"),
    ...
    path(
        "academy/asset/<str:asset_slug>/action/<str:action_slug>",
        AcademyAssetActionView.as_view(),
        name="academy_asset_slug_action_slug",
    ),
    ...
    path("academy/asset/<str:asset_slug_or_id>", AcademyAssetView.as_view()),
    ...
    path("technology.<str:extension>", TechnologyView.as_view(), name="technology_by_extension"),
