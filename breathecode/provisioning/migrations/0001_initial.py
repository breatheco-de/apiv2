    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('PENDING', 'Pending'), ('PERSISTED', 'Persisted'), ('ERROR', 'Error')],
                                  default='PENDING',
                                  max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('academy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admissions.academy')),
                ('allowed_machine_types', models.ManyToManyField(blank=True,
                                                                 to='provisioning.ProvisioningMachineTypes')),
                ('vendor',
                 models.ForeignKey(default=None,
                                   null=True,
                                   on_delete=django.db.models.deletion.SET_NULL,
