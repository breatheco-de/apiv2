            ...
            fields=[
                ...
                ('cohorts',
                 models.ManyToManyField(
                     blank=True,
                     help_text=
                     'If set, only these cohorts will be provisioned with this vendor in this academy',
                     to='admissions.Cohort')),
                ('members',
                 models.ManyToManyField(
                     blank=True,
                     help_text=
                     'If set, only these members will be provisioned with this vendor in this academy',
