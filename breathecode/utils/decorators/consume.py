...
def consume(service: str, consumer: Optional[Consumer] = None, format:str='json') -> callable:
    ...
    def decorator(function: callable) -> callable:
        ...
        def build_context(request: HttpRequest | AsyncRequest, utc_now: datetime, **opts: Unpack[ServiceContext]) -> ServiceContext:
            return {
                'utc_now': utc_now,
                'consumer': consumer,
                'service': service,
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if context['price'] and context['lifetime'] and (consumable :=
                                                                                     context['consumables'].first()):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                if context['price'] and context['lifetime'] and (consumable := await
                                                                                     context['consumables'].afirst()):
