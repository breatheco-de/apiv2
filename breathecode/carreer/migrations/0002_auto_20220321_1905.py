    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('platform',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='carreer.platform')),
            ],
        ),
        migrations.CreateModel(
            name='Spider',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('position',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='carreer.position')),
                ('zyte_project',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='carreer.zyteproject')),
            ],
        ),
        migrations.CreateModel(
            name='PositionAlias',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('location',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='carreer.location')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('carreer_tags', models.ManyToManyField(blank=True, null=True, to='carreer.CarreerTag')),
                ('employer',
                 models.ForeignKey(blank=True,
                                   null=True,
                                   on_delete=django.db.models.deletion.CASCADE,
                                   to='carreer.employer')),
                ('locations', models.ManyToManyField(blank=True, null=True, to='carreer.Location')),
                ('position',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='carreer.position')),
                ('spider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                             to='carreer.spider')),
            ],
        ),
        migrations.AddField(
