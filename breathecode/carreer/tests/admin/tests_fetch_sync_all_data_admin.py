...
from breathecode.tests.mocks.django_contrib import DJANGO_CONTRIB_PATH, DJANGO_CONTRIB_INSTANCES, apply_django_contrib_messages_mock
from breathecode.carreer.models import Spider
from breathecode.carreer.admin import fetch_sync_all_data_admin
...
class RunSpiderAdminTestSuite(CarreerTestCase):
    ...
    @patch('breathecode.carreer.actions.fetch_sync_all_data',
           MagicMock(side_effect=Exception('They killed kenny')))
    def test_fetch_sync_all_data_admin__with_zero_spider(self):
        from breathecode.carreer.actions import fetch_sync_all_data
    ...
    @patch(DJANGO_CONTRIB_PATH['messages'], apply_django_contrib_messages_mock())
    @patch('breathecode.carreer.actions.fetch_sync_all_data', MagicMock())
