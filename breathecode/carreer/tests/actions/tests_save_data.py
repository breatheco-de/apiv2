...
class ActionSaveDataTestCase(CarreerTestCase):
    def test_save_data__with_spider(self):
        ...
        self.assertEqual(self.bc.database.list_of('carreer.Job'), [{
            'id': 1,
    ...
    def test_give_two_employer_repited(self):
        ...
        employer = self.bc.database.list_of('carreer.Employer')
    ...
    def test_give_two_jobs_repited_save_one(self):
        ...
        job = self.bc.database.list_of('carreer.Job')
    ...
    def test_give_two_location_alias_repited(self):
        ...
        location = self.bc.database.list_of('carreer.Location')
        location_alias = self.bc.database.list_of('carreer.LocationAlias')
