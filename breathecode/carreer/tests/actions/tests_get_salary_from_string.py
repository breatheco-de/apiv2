...
from breathecode.carreer.services.getonboard import GetonboardScraper
from breathecode.carreer.services.indeed import IndeedScraper
...
class ActionGetSalaryFromStringTestCase(CarreerTestCase):
