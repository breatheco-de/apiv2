...
from breathecode.carreer.services import ScraperFactory
from ..mixins import CarreerTestCase


class ServicesGetClassScraperFactoryTestCase(CarreerTestCase):
    ...
    def test_return_false(self):
        ...
        self.assertEqual(Logger.error.call_args_list, [
            call('There was an error import the library - No '
                 "module named 'breathecode.carreer.services.motor'")
        ])
    ...
    def test_get_class_correctly(self):
        ...
        self.assertEqual(result.__module__, 'breathecode.carreer.services.getonboard')
