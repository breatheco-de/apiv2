...
from .views import (
    AnswerMeView, GetAnswerView, track_survey_open, get_survey_questions,
    SurveyView, AcademyAnswerView
)
...
urlpatterns = [
    ...
    path('academy/answer/<int:answer_id>', AcademyAnswerView.as_view(), name='answer_id'),
