...
from .views import (AnswerMeView, GetAnswerView, track_survey_open, get_survey_questions, SurveyView,
                    AcademyAnswerView, ReviewView, AcademyReviewView, get_review_platform)
...
urlpatterns = [
    ...
    path('academy/review', AcademyReviewView.as_view(), name='review'),
    path('academy/review/<int:review_id>', AcademyReviewView.as_view(), name='review_id'),
