...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='answer',
            name='survey',
            field=models.ForeignKey(blank=True, default=None, help_text='You can group one or more answers in one survey, the survey does not belong to any student in particular but answers belong to the student that answered', null=True, on_delete=django.db.models.deletion.SET_NULL, to='feedback.survey'),
        ),
    ]
