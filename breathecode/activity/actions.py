...
class FillActivityMeta:
    ...
    def answer(cls,
        ...
        return {
            ...
            'mentor_email': instance.mentor.email if instance.mentor else None,
            'mentor_username': instance.mentor.username if instance.mentor else None,
            'mentor_first_name': instance.mentor.first_name if instance.mentor else None,
            'mentor_last_name': instance.mentor.last_name if instance.mentor else None,
            'cohort': instance.cohort.id if instance.cohort else None,
