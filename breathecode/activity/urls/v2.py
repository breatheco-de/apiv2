...
from ..views import V2AcademyActivityReportView, V2AcademyActivityView, V2MeActivityView
...
urlpatterns = [
    ...
    path("me/activity/<str:activity_slug>", V2MeActivityView.as_view(), name="me_activity_slug"),
