...
class Recaptcha:
    ...
    def create_assessment(self, project_id: str, recaptcha_site_key: str, token: str,
    ...
    def create_assessment_v2(self, project_id: str, recaptcha_site_key: str, token: str,
                             recaptcha_action: str) -> Assessment:
        """Create an assessment to analyze the risk of a UI action.
        Args:
            project_id: GCloud Project ID
