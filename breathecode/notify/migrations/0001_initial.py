    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sync_status', models.CharField(choices=[('INCOMPLETED', 'Incompleted'), ('COMPLETED', 'Completed')], default='INCOMPLETED', help_text='Automatically set when synqued from slack', max_length=15)),
                ...
                ('credentials', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='authenticate.credentialsslack')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sync_status', models.CharField(choices=[('INCOMPLETED', 'Incompleted'), ('COMPLETED', 'Completed')], default='INCOMPLETED', max_length=15)),
                ('sync_message', models.CharField(blank=True, default=None, help_text='Contains any success or error messages depending on the status', max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cohort', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='notify.slackteam')),
            ],
        ),
        migrations.CreateModel(
