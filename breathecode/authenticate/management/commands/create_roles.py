...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        roles.append({ "slug": "country_manager", "name": "Country Manager", "caps": extend(roles,["academy_coordinator", "student", "career_support", "growth_manager"]) + ["crud_cohort", "read_cohort"] })
