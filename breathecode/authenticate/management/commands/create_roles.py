...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        caps = [
            ...
            { "slug": "read_media_resolutions", "description": "List all the medias resolutions" },
            { "slug": "crud_media_resolutions", "description": "Create, update or delete academy media resolutions" },
        ...
        roles = [
            ...
            { "slug": "staff", "name": "Staff (Base)", "caps": ["read_member", "read_syllabus", "read_student", "read_cohort", "read_media","read_media_resolutions", "read_my_academy", "read_invite", "get_academy_token" ] },
