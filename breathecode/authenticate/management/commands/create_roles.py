...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        caps = [
            ...
            { "slug": "classroom_activity", "description": "To report student activities during the classroom or cohorts (Specially meant for teachers)" },
        ]
        ...
        roles.append({ "slug": "assistant", "name": "Teacher Assistant", "caps": extend(roles, ["staff"]) + ["read_assigment", "crud_assignment", "read_cohort_activity", "read_nps_answers", "classroom_activity"] })
