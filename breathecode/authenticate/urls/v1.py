...
urlpatterns = [
    ...
    path("academy/<int:academy_id>/capability", AcademyCapabilityListView.as_view(), name="academy_id_capability"),
    path("academy/<int:academy_id>/role", AcademyRoleView.as_view(), name="academy_id_role"),
    path("academy/<int:academy_id>/role/<str:role_slug>", AcademyRoleSlugView.as_view(), name="academy_id_role_slug"),
    ...
    path("academy/invite/<int:invite_id>/claim", AcademyInviteClaimView.as_view(), name="academy_invite_id_claim"),
    ...
    path("github/<int:user_id>", GithubUserByIdView.as_view(), name="github_user_by_id"),
