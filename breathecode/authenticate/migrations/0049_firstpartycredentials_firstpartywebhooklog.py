    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('health_status', models.JSONField(blank=True,
                                                   default={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, default='unknown', help_text='Type of the webhook',
                                          max_length=50)),
                ('user_id',
                 models.IntegerField(blank=True, default=None, help_text='User ID who triggered the webhook',
                                     null=True)),
                ('external_id',
