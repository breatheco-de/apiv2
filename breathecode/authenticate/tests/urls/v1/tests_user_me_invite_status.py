...
class MemberSetOfDuckTestSuite(AuthTestCase):
    ...
    @patch("breathecode.authenticate.signals.invite_status_updated.send_robust", MagicMock())
...
class AuthenticateTestSuite(AuthTestCase):
    ...
    def test_user_me_invite_status__passing_invalid_status(self):
        ...
        model = self.generate_models(
            academy=True, capability="crud_invite", authenticate=True, role="potato", profile_academy=True
        )
    ...
    def test_user_me_invite_status__to_accepted_in_bulk_with_ids(self):
        ...
        model1 = self.generate_models(
            authenticate=True, profile_academy=True, user_invite=True, user_invite_kwargs=invite_kwargs, models=base
        )
        invite_kwargs["id"] = 2
