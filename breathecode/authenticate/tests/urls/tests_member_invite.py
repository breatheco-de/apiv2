    ...
    return loader.render_to_string(
        'user_invite.html', {
            ...
            'invites': [{
                ...
                } if user_invite.academy else None,
                'cohort': {
                    'id':
                    user_invite.cohort.id,
                    'name':
                    user_invite.cohort.name,
                    'slug':
                    user_invite.cohort.slug,
                    'ending_date':
                    self.bc.datetime.to_iso_string(user_invite.cohort.ending_date)
                    if user_invite.cohort.ending_date else None,
                    'stage':
                    user_invite.cohort.stage,
                } if user_invite.cohort else None,
