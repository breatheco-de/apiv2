...
class AuthenticateTestSuite(AuthTestCase):
    ...
    def test_academy_student_delete_in_bulk_with_one_relationships(self):
        """Test /cohort/:id/user without auth"""
        self.headers(academy=1)
        ...
        for field in many_fields:
            ...
            url = reverse_lazy('authenticate:academy_student') + f'?{field}=' + str(value)
            response = self.client.delete(url)
    ...
    def test_academy_student_delete_in_bulk_with_two_relationships(self):
        """Test /cohort/:id/user without auth"""
        self.headers(academy=1)
        many_fields = ['user', 'academy', 'role']
    ...
    def test_academy_student_delete_in_bulk_with_two_relationships_but_is_not_student(self):
        """Test /cohort/:id/user without auth"""
        self.headers(academy=1)
        many_fields = ['user', 'academy', 'role']
