    ...
    return [
        call(
            ...
            email,
            {
                ...
                "LINK": "http://localhost:8000/v1/auth/academy/html/invite",
            },
            academy=academy,
        ),
    ]
...
class AuthenticateTestSuite(AuthTestCase):
    ...
    def test_resend_invite__get__profile_academy_and_user_invite_not_found(self):
        ...
        model = self.generate_models(
            authenticate=True, profile_academy=True, capability="read_invite", role="potato", syllabus=True
        )
    ...
    def test_resend_invite__get__profile_academy_with_status_active(self):
        ...
        model = self.generate_models(
            authenticate=True, profile_academy=profile_academy, capability="read_invite", role=1, syllabus=1
        )
    ...
    def test_resend_invite__put__profile_academy_with_status_invited(self):
        ...
        self.headers(academy=1)
        model = self.generate_models(
            authenticate=True, profile_academy=1, capability="read_invite", role="potato", syllabus=1
        )
    ...
    def test_resend_invite__put__profile_academy_with_status_invited__(self):
        ...
        self.headers(academy=1)
        model = self.generate_models(
            authenticate=True, profile_academy=1, capability="read_invite", role="potato", user_invite=1, syllabus=1
        )
