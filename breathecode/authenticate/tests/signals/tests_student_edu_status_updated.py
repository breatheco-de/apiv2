...
class TestAsyncRemoveFromOrganization:
    ...
    def test_the_requirements_are_met__it_is_not_triggered_twice(self, bc: Breathecode, set_datetime, old_status,
                                                                 new_status):
...
class TestGenerateCertificate:
    ...
    @pytest.mark.parametrize('available_as_saas, educational_status', [
        (False, 'GRADUATED'),
        (True, 'ACTIVE'),
        (True, 'POSTPONED'),
        (True, 'SUSPENDED'),
    ...
    def test_the_requirements_are_not_met(self, bc: Breathecode, available_as_saas, educational_status):
        bc.database.create(cohort_user={'educational_status': educational_status},
                           cohort={'available_as_saas': available_as_saas})
