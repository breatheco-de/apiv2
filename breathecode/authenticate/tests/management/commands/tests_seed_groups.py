...
class TokenTestSuite(AuthTestCase):
    ...
    def test__execute__with_three_users_and_three_mentor_profiles(self):
        ...
        for user in model.user:
            self.assertEqual(self.bc.format.table(user.groups.all()), [
                {
                    'id': 1,
                    'name': 'Default'
                },
    ...
    def test__execute__with_three_users_of_all_tables__role_student__three_different_cases(self):
        ...
        self.assertEqual(self.bc.format.table(model.user[0].groups.all()), [
            {
                'id': 1,
                'name': 'Default'
            },
        ...
        self.assertEqual(self.bc.format.table(model.user[1].groups.all()), [
            {
                'id': 1,
                'name': 'Default'
            },
        ...
        self.assertEqual(self.bc.format.table(model.user[2].groups.all()), [
            {
                'id': 1,
                'name': 'Default'
            },
