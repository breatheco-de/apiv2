...
# web: export CORALOGIX_SUBSYSTEM=web; daphne breathecode.asgi:application --port $PORT --bind 0.0.0.0 -v2 --http-timeout 30
web: export CORALOGIX_SUBSYSTEM=web; gunicorn breathecode.wsgi --timeout 25
