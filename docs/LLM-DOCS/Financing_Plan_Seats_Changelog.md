...
- **Seat operations (`payments/actions.py`)**
  ...
  - Financing checkout now bills per-seat add-ons (team seats) the same way subscriptions do; the seat price is added to the installment amount before coupons.
